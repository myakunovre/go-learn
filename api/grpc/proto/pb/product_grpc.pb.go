...
//
// Сервис для получения товара из core-сервиса
type ProductServiceClient interface {
	GetProducts(ctx context.Context, in *GetProductRequest, opts ...grpc.CallOption) (*ProductResponse, error)
}
...
func (c *productServiceClient) GetProducts(ctx context.Context, in *GetProductRequest, opts ...grpc.CallOption) (*ProductResponse, error) {
...
type ProductServiceServer interface {
	GetProducts(context.Context, *GetProductRequest) (*ProductResponse, error)
...
func (UnimplementedProductServiceServer) GetProducts(context.Context, *GetProductRequest) (*ProductResponse, error) {
